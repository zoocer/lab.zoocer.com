...
function() {
	...
	$(document).ready(function(e) {
		...
		$("#loading").hide(),
		$("body").append('<div id="ikea-audio" class="ikea-audio abs"><div class="music"><p class="music_audio"><span class="abs audio_open"></span><span class="abs audio_close"></span></p><audio id="music_audio" loop="loop" preload="preload"><source src="" type="audio/mpeg">\u60a8\u7684\u6d4f\u89c8\u5668\u4e0d\u652f\u6301HTML5\u97f3\u9891\u683c\u5f0f</audio></div></div>');
		var _height = $(window).height(),
		_width = $(window).width();
		_width = _width > 720 ? 720 : _width,
		_phoneScale = _width / 640,
		_targetH = 960 * _phoneScale,
		...
		$("#device").css({
			height: _targetH,
			width: _width,
			top: 960 > _height ? -(960 * _phoneScale - _height) / 2 : _height
		}),
		...
		function() {
			...
			_videostart = !0,
			$("#video").delay(500).show().find("video")[0].play()
		}),
		...
		var mySwiper = new Swiper("#swiper-container", {
			...
			onSlideChangeStart: function(a) {
				...
				_videostart && $("#video").delay(500).hide().find("video")[0].pause()
			},
		...
		descContent = "",
		shareTitle = "StyleTVç‰¹è¾‘ï¼šç§¦å²šâ€”â€”â€œç§¦â€ç³»å·´é»Ž ä¸å¯é”™è¿‡çš„å¥½é£Žæ™¯",
		appid = "";
